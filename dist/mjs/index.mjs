...
import { defineComponent, ref, reactive, watch, computed, readonly, watchEffect, onMounted, onUnmounted, toRef, unref, isRef, withDirectives, h, Fragment, Comment, Text, Static, nextTick, openBlock, createBlock, Teleport, createVNode, Transition, withCtx, createElementBlock, mergeProps, renderSlot, createTextVNode, toDisplayString, createCommentVNode, shallowReactive, provide, inject, createElementVNode, normalizeClass, resolveDynamicComponent, normalizeProps, renderList, normalizeStyle, withKeys, resolveComponent, resolveDirective, toHandlers, withModifiers, guardReactiveProps } from "vue";
...
function getPopoverEventHandlers(opts) {
  ...
  let focused = false;
  let target = null;
  const isClick = computed(() => (unref(opts).action ?? "click") === "click");
  const isHover = computed(() => unref(opts).action === "hover");
  const isHoverOrFocus = computed(() => unref(opts).action === "hover-focus");
  const isFocus = computed(() => unref(opts).action === "focus");
  const clickHandler = (e) => {
    if (isClick.value) {
      target = e.currentTarget;
      togglePopover({ target, ...unref(opts) });
      e.stopPropagation();
    }
  };
  ...
  if (isRef(opts)) {
    watch(
      ...
      () => {
        if (target) {
          updatePopoverState({ target, ...unref(opts) });
        }
      }
    );
  }
...
const _sfc_main$2$1 = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const actualPlacement = ref(null);
    ...
    return {
      actualPlacement,
      align,
      contentClass: toRef(state2, "contentClass"),
      theme: toRef(state2, "theme"),
      data: toRef(state2, "data"),
      direction,
      interactive: toRef(state2, "interactive"),
      middleware,
      popoverRef,
      style: style2,
      teleport: toRef(state2, "teleport"),
      transitions: toRef(state2, "transitions"),
      visible: toRef(state2, "visible"),
      hide,
      onClick,
      onMouseOver,
      onMouseLeave,
  ...
  return openBlock(), createBlock(Teleport, {
    ...
    createVNode(Transition, {
      ...
      default: withCtx(() => {
        var _a, _b;
        return [
          _ctx.visible ? (openBlock(), createElementBlock("div", mergeProps({ key: 0 }, _ctx.$attrs, {
            class: [
...
const _sfc_main$j = {
  ...
  render() {
    return h(_sfc_main$1$1, this.$props, this.$slots);
  }
};
...
const state = shallowReactive(defaultConfig);
...
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(PopoverContent), {
        name: unref(dayPopoverName),
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(show).title ? (openBlock(), createElementBlock("div", _hoisted_2$5, [
          createVNode(_sfc_main$h, { name: "header-title-wrapper" }, {
            default: withCtx(() => [
              withDirectives((openBlock(), createElementBlock("button", _hoisted_3$4, [
                ...
                [unref(directive), unref(navPopoverOptions)]
              ])
            ]),
            _: 1
          })
      ...
      return openBlock(), createBlock(unref(PopoverContent), {
        ...
        default: withCtx(({ data: data2 }) => [
          createVNode(_sfc_main$8, {
            ...
            default: withCtx(() => [
              createVNode(_sfc_main$h, { name: "nav" }, {
                default: withCtx(() => [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        __props.showIcon ? (openBlock(), createBlock(_sfc_main$b, {
          key: 0,
          name: "ChevronDown",
          size: "18"
        })) : createCommentVNode("", true),
  ...
  setup(__props, { expose }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createVNode(_sfc_main$h, { name: "time-header" }, {
          default: withCtx(() => [
        ...
        createElementVNode("div", _hoisted_6, [
          ...
          !unref(is24hr) ? (openBlock(), createBlock(_sfc_main$3, {
            key: 3,
    ...
    return (_ctx, _cache) => {
      return unref(isTimeMode) ? (openBlock(), createElementBlock("div", {
        ...
        footer: withCtx(() => [
          ...
          createVNode(_sfc_main$h, { name: "dp-footer" })
        ]),
        _: 1
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_PopoverContent = resolveComponent("PopoverContent");
  return _ctx.$slots.default ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
    ...
    createVNode(_component_PopoverContent, {
      ...
      placement: "bottom-start",
      class: normalizeClass(`vc-date-picker-content vc-${_ctx.color} vc-${_ctx.displayMode}`),
      ...
      default: withCtx(() => [
        createVNode(_component_DatePickerBase, normalizeProps(guardReactiveProps(_ctx.$attrs)), null, 16)
      ]),
      _: 1
...
export {
  Calendar,
  _sfc_main$i as CalendarDayPopoverRow,
  DatePicker,
  index$3 as Popover,
  createCalendar,
  createDatePicker,
